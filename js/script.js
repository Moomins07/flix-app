const global = {
  ...
  api: {
    apiKey: '05e6785afae27aae5da9bb3f0c1a69ee',
...
async function displayMovieDetails() {
  ...
  // .search returns ?id=502356, we split into an array of ?id & 502356 as we just need number
...
<div class="details-bottom">
  <h2>Movie Info</h2>
  <ul>
    <li><span class="text-secondary">Budget:</span> ${checkBudget}</li>
    <li><span class="text-secondary">Revenue:</span> ${checkRevenue}</li>
...
async function search() {
  ...
  if (global.search.term !== '' && global.search.term !== null) {
    ...
    // Added this to stop single results blowing up the screen
    if (results.length === 1) {
...
// Adds commas to large numbers for budget/revenue
